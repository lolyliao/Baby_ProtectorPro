...
- (void)setUpMenuBtns{
    ...
    UIFont *btnFont = [UIFont fontWithName:@"Arial" size:13];
    ...
    for (int i = 0; i < self.menuArray.count; i++) {
        ...
        menuBtn.frame = CGRectMake(menuBtnX, 5, btnRect.size.width+10, 20);
...
- (void)setSelectedBtn:(UIButton *)selectedBtn{
    ...
    selectedBtn.backgroundColor = [UIColor colorwithHexString:@"#ffcccc"];
